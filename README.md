...
2. **Type anything — even "hi".** On a fresh OS the **`onboard`** skill takes over and does setup
   *for* you, in order: installs its plugins, has you open the vault, and connects Google in your
...
| `SETUP-PLAYBOOK.md` | The manual `onboard` follows: plugins, open-as-vault, Google connector. |
